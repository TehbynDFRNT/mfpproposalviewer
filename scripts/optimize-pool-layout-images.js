// scripts/optimize-pool-layout-images.js
import fs from 'fs/promises';
import path from 'path';
import fg from 'fast-glob';
import sharp from 'sharp';

const SRC = 'public/Pools/Pool-Layout/Raw';
const OUT = 'public/Pools/Pool-Layout';
...
console.log(`Found ${files.length} layout images to optimize`);
...
console.log('Layout image optimization complete!');