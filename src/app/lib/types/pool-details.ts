...
export const POOL_DETAILS: Record<string, PoolDetail> = {
  'Verona': {
    ...
    layoutImage: '/Pools/Pool-Layout/verona_layout.webp',
  },
  'Sheffield': {
    name: 'Sheffield',
    ...
    layoutImage: '/Pools/Pool-Layout/sheffield_layout.webp',
  },
  'Latina': {
    name: 'Latina',
    ...
    layoutImage: '/Pools/Pool-Layout/latina_layout.webp',
  },
  'Small Latina': {
    name: 'Small Latina',
...
export function getPoolDetails(specName: string): PoolDetail {
  ...
  return {
    ...
    layoutImage: '/Pools/Pool-Layout/verona_layout.webp', // Default layout image
  };
}